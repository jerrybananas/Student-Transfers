...
public class UserController {
	...
	public String validateDocuments(Model model, @PathVariable("id") int id) {
		...
		for (Student eachStudent : students) {
			if (eachStudent.getStudent_id() == id) {
				student2 = eachStudent;
				model.addAttribute("student", eachStudent);
			}
		}
		model.addAttribute("pageTitle", "Validate student documents");
		return "staff-validations";
	}
	...
	@RequestMapping(value = "verify/Documents", method = RequestMethod.POST, produces = { "application/json",
			"application/xml" })
	public String verifyDocuments(@RequestParam("E1_verified") boolean E1_verified,
			@RequestParam("Ekkatharistiko_verified") boolean Ekkatharistiko_verified,
			@RequestParam("Police_identity_verified") boolean Police_identity_verified,
			@RequestParam("Student_identity_verified") boolean Student_identity_verified) {
		System.out.println(student2.toString());
		student2.setE1_verified(E1_verified);
		student2.setEkkatharistiko_verified(Ekkatharistiko_verified);
		student2.setPolice_identity_verified(Police_identity_verified);
		student2.setStudent_identity_verified(Student_identity_verified);
		System.out.println(student2.toString());
